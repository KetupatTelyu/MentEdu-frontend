<template>
  <div class="max-w-sm">
    <div class="text-center mb-8">
      <h1 class="text-3xl font-bold leading-8 text-gray-900">Masuk ke Akunmu</h1>
      <p class="text-gray-500 text-base font-normal leading-normal">
        Selamat datang kembali! Isi formulir login dibawah <br />
        untuk melanjutkan
      </p>
    </div>
    <form
      ...
      <div class="flex items-center justify-between my-6">
        <div class="flex items-center">
          ...
          <label
            for="remember"
            class="ms-2 text-sm font-medium leading-tight text-gray-900"
            >Ingat Saya</label
          >
        </div>
        <div>
          <a class="text-sm font-bold leading-tight" href="">Lupa Password</a>
        </div>
      </div>
      <button
        type="submit"
